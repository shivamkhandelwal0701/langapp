          ...
          <div className="row justify-content-center">
            <div className="col-md-8">
              <div className="text-center">
                ...
                <p className="lead">
                  Start your language learning journey today and explore the
                  world of languages.
                </p>
              </div>
              <hr className="my-4" />
              <div className="row">
                <div className="col-md-6 mb-4">
                  ...
                  <p>
                    ...
                    interested in expanding your horizons, language learning is
                ...
                <div className="col-md-6 mb-4">
                  ...
                  <p>
                    ...
                    immersive exercises, and personalized feedback, you'll be
                    able to progress at your own pace and achieve fluency in
